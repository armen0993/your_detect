package com.ml.mlkit.presentation.custom_view.pasport_detect
...
class RectanglePassportDetectSuccess @JvmOverloads constructor(
    context: Context,
    ...
    private val qrScannerWidth = 300.toPx
    private val qrScannerHeight = 420.toPx


    private val verticalOffset = 0.45f
